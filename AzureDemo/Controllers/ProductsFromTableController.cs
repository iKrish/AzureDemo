...
{
    public class ProductsFromTableController : Controller
    {
        ...
        {
            storageAccount = CloudStorageAccount.Parse(CloudConfigurationManager.GetSetting("azstoragez_AzureStorageConnectionString"));
            tableClient = storageAccount.CreateCloudTableClient();
            table = tableClient.GetTableReference(CloudConfigurationManager.GetSetting(
            "tableName"));
        }
